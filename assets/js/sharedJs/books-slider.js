...
// get a certain number of books from a certain page
let booksFetchingUrl = `http://webstercassin1-001-site1.ftempurl.com/api/Items/paged?search=mart&PageNumber=1&PageSize=20`;
...
async function getAllBooks() {
  try {
    ...
    let recentBooks = data.data;
    // add books to the slider
    recentBooks.forEach((book) => {
      // for each book create a div with class book and insert it's data inside
